...
//		int qteProdutos = 100;
		...
		System.out
				.println("Digite a media e a variancia do tempo do atendente");
		 ...
		 * de 90%
		 * 
		 * type - The termination condition type. This must be set to
		 * INTERVAL_ACCURACY. output_analysis_type - The output analysis method
		 * to be used as a variance reduction technique level - The confidence
		 * level for which the confidence interval will be calculated accuracy -
		 * The accuracy that is required to satisfy the termination condition
		 * entity - The name of the entity that contains the measure upon which
		 * the termination condition is based measure - The name of the custom
...
//				"fonte", 1, 10, false);
		...
		// System.out.println("Qte atendimentos efetuados = " +
		// atendente.getQteAtendimentosEfetuados());
		System.out
				.println("Qte atendimentos nao realizados por nao ter produto = "
						+ atendente.getNaoTemProduto());
		System.out
				.println("Qte atendimentos nao realizados por produto vencido = "
						+ atendente.getPerdasPorValidade());
		// System.out.println("Qte produtos vencidos = " +
		// atendente.getProdutosVencidos());
		// System.out.println("qte perdeu validade = " +
		// atendente.getQtePerdeuValidade());
		// System.out.println("qte acabou estoque = " +
		// atendente.getAcabouEstoque());
		// System.out.println();
		// System.out.println("===> Caixa <===");
		// System.out.println("Qte vendas efetuadas = " +
		// caixa.getVendasEfetuadas());
		// System.out.println("Qte vendas perdidas = " +
		// caixa.getVendasPerdidas());
		// if(atendente.getQteAtendimentosEfetuados() <
		// caixa.getVendasEfetuadas()){
